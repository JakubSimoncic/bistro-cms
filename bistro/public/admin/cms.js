// Vlastní jednoduchý markdown widget, který udržuje pozici kurzoru
function MarkdownControl({ value, onChange }) {
  ...
  textarea.addEventListener('input', e => {
    ...
    // Nastav kurzor zpět na původní pozici
...
// Počkej, až se načte CMS, pak zaregistruj widget a spusť CMS
